...
```{r, cache=TRUE}
# Histogram of only those entries with more than 5000 minutes between updates.
...
```{r, cache=TRUE}
# Entries with less than 5000 minutes between updates, on a log-y scale.
# The ..count..+1 avoids ugly blocks hanging down where there are no entries.
...
# entries with the same value for rain. Then we stack bars of that height on
# top of each other.
